...
```text
artifacts/release/winTerm-0.7.0-beta.5-setup-x64.exe
artifacts/release/winTerm-0.7.0-beta.5-portable-x64.zip
```
...
.\scripts\winterm\test-installer.ps1 `
  -InstallerPath .\artifacts\release\winTerm-0.7.0-beta.5-setup-x64.exe `
  -Version 0.7.0-beta.5
```
