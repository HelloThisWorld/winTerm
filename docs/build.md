...
```text
artifacts/release/winTerm-1.0.0-setup-x64.exe
artifacts/release/winTerm-1.0.0-portable-x64.zip
```
...
.\scripts\winterm\test-installer.ps1 `
  -InstallerPath .\artifacts\release\winTerm-1.0.0-setup-x64.exe `
  -Version 1.0.0
```
