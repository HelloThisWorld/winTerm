...
No 1.0.1 manifest is committed before the public GitHub Release exists. The installer URL and SHA-256 must come from the actually published `winTerm-1.0.1-x64.msix`; placeholders and Actions artifact URLs are forbidden.

After publication, `.github/workflows/winget.yml`:

1. confirms `v1.0.1` is public and not a Prerelease;
