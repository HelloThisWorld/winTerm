...
The current source version is `0.7.0-beta.3`. Existing GitHub tags and Release
...
[release notes](docs/releases/0.7.0-beta.3.md).
...
.\scripts\winterm\build-installer.ps1 -Version 0.7.0-beta.3 -Platform x64
.\scripts\winterm\build-portable.ps1 -Version 0.7.0-beta.3 -Platform x64
```
