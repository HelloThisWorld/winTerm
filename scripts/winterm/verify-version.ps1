...
try
{
    ...
    Assert-Condition ($version.packageVersion -eq '1.0.8.0') 'Package version is 1.0.8.0'
    ...
    Assert-Condition ($version.tag -eq 'v1.0.0') 'Stable tag is v1.0.0'
    ...
    Assert-Condition ((Get-Text 'CHANGELOG.md').Contains('## 1.0.0 - 2026-07-22')) 'Changelog contains 1.0.0'
