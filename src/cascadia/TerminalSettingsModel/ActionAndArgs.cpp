...
static constexpr std::string_view BalancePanesKey{ "balancePanes" };
static constexpr std::string_view UndoPaneResizeKey{ "undoPaneResize" };
static constexpr std::string_view RedoPaneResizeKey{ "redoPaneResize" };
...
static constexpr std::string_view ToggleCommandTimelineKey{ "toggleCommandTimeline" };
